...
void __cdecl main()
{
	...
	video_ffmepg("d:\\test.mp4");
	// video_ffmepg("game:\\onepiece.mp4");
	// video_ffmepg("game:\\wolverine.mp4");
...
HRESULT video_ffmepg(char * v)
{
	...
	if(pFFMpegData->audioStreamNumber>=0)
	{
		...
		}else
		{
			...
			//pFFMpegData->pAudioCodecCtx->thread_count = 4;
			//avcodec_thread_init(pFFMpegData->pAudioCodecCtx, THREAD_COUNT);
