...
VERTEX triangleStripVerticesBtn[4];

struct SDL_PrivateVideoData {
	LPDIRECT3DTEXTURE9 SDL_primary;
	LPDIRECT3DTEXTURE9 SDL_Buttons;
...
LPDIRECT3DVERTEXBUFFER9 vertexBuffer, overlayVBuffer;
LPDIRECT3DVERTEXBUFFER9 vertexBufferBtn;
LPDIRECT3DVERTEXDECLARATION9 vertexDeclaration, OverlayVertDec;
LPDIRECT3DVERTEXDECLARATION9 vertexDeclarationBtn;
D3DVertexShader* g_pGradientVertexShader, *OverlayVShader;
D3DVertexDeclaration* g_pGradientVertexDecl, *OverlayDecl;
D3DVertexDeclaration* g_pGradientVertexDeclBtn;
D3DPixelShader* g_pPixelShader, *OverlayShader;
LPD3DXBUFFER ppShader, pOShader;
LPD3DXBUFFER pPixelShaderCode, pOShaderCode;
LPD3DXBUFFER pPixelErrorMsg, pOShaderError;
