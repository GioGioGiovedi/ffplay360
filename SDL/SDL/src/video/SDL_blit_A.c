...
typedef _DECLSPEC_ALIGN_16_ struct XMVECTORU16 {
    union {
        unsigned short u[8];
        XMVECTOR v;
    };
...
#else
    #define VECUINT8_LITERAL(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p) \
         (XMVECTORU8){ a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p }
    #define VECUINT16_LITERAL(a,b,c,d,e,f,g,h) \
        (__vector4) { a,b,c,d,e,f,g,h }
#endif
...
/* the permuation vector that takes the high bytes out of all the appropriate shorts 
    (vector unsigned char)(
        ...
        0x0C, 0x1C, 0x0E, 0x1E );
*/
#define VEC_MERGE_PERMUTE() (XMVectorAdd(vec_lvsl(0, (int*)NULL), (vector unsigned char)vec_splat_u16(0x0F)))
...
static XMVECTOR calc_swizzle32(const SDL_PixelFormat *srcfmt,
                               const SDL_PixelFormat *dstfmt)
{
	...
	XMVECTOR vswiz;
    XMVECTOR srcvec;
	XMVECTORU8 plus = { 0x00, 0x00, 0x00, 0x00,
                             0x04, 0x04, 0x04, 0x04,
                             0x08, 0x08, 0x08, 0x08,
							 0x0C, 0x0C, 0x0C, 0x0C };
...
#undef RESHIFT  
	...
	vswiz = XMVectorAdd(plus.v, XMVectorSplatConstantInt(((unsigned int *)(char*)&srcvec)[0]));
    return(vswiz);
}
...
static void Blit32to565PixelAlphaAltivec(SDL_BlitInfo *info)
{
    ...
    XMVECTOR v0 = XMVectorSplatConstantInt(0);
    XMVECTOR v8_16 = XMVectorSplatConstantInt(8);
    XMVECTOR v1_16 = XMVectorSplatConstantInt(1);
    XMVECTOR v2_16 = XMVectorSplatConstantInt(2);
    XMVECTOR v3_16 = XMVectorSplatConstantInt(3);
    XMVECTOR v8_32 = XMVectorSplatConstantInt(8);
    XMVECTOR v16_32 = XMVectorAdd(v8_32, v8_32);
	XMVECTORU16 v3f = {
    ...
    */
    ...
    XMVECTOR vredalpha2 = (
        XMVectorAdd(vredalpha1.v, XMVectorShiftLeft(v8_32, v16_32, 0))
    );
    /*
    ...
    */
    ...
    XMVECTOR vgreen2 = 
        XMVectorAdd(vgreen1.v, XMVectorShiftLeft(v8_32,v8_32, 0));
    ...
    XMVECTOR mergePermute = VEC_MERGE_PERMUTE();
    XMVECTOR vpermute = calc_swizzle32(srcfmt, NULL);
    XMVECTOR valphaPermute = vec_and(vec_lvsl(0, (int *)NULL), vec_splat_u8(0xC));

    XMVECTOR vf800 = (vector unsigned short)vec_splat_u8(-7);
    vf800 = vec_sl(vf800, vec_splat_u16(8));

    while(height--) {
        int extrawidth;
        XMVECTOR unsigned char valigner;
        XMVECTOR unsigned char vsrc;
        XMVECTOR unsigned char voverflow;
        int width = info->d_width;
...
#define ONE_PIXEL_BLEND(condition, widthvar) \
        ...
        while (width) {
            XMVECTOR valpha;
            XMVECTOR vsrc1, vsrc2;
            XMVECTOR vdst1, vdst2;
            XMVECTOR vR, vG, vB;
            XMVECTOR vpixel, vrpixel, vgpixel, vbpixel;
...
static void Blit32to32SurfaceAlphaKeyAltivec(SDL_BlitInfo *info)
{
    ...
    XMVECTOR mergePermute;
    XMVECTOR vsrcPermute;
    XMVECTOR vdstPermute;
    XMVECTOR vsdstPermute;
    XMVECTOR valpha;
    XMVECTOR valphamask;
    XMVECTOR vbits;
    XMVECTOR v0;
...
#define ONE_PIXEL_BLEND(condition, widthvar) \
        ...
        if (width > 0) {
            ...
            XMVECTOR valigner = VEC_ALIGNER(srcp);
            XMVECTOR vs = (vector unsigned char)vec_ld(0, srcp);
            width -= extrawidth;
            while (width) {
                XMVECTOR vsel;
                XMVECTOR voverflow;
