...
int SDL_SYS_JoystickOpen(SDL_Joystick *joystick)
{
	...
	joystick->hwdata->pGamepads.fX1 = ConvertThumbstickValue( joystick->hwdata->pGamepads.sThumbLX, XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE );
	joystick->hwdata->pGamepads.fY1 = ConvertThumbstickValue( joystick->hwdata->pGamepads.sThumbLY, XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE );
	joystick->hwdata->pGamepads.fX2 = ConvertThumbstickValue( joystick->hwdata->pGamepads.sThumbRX, XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ); //joystick->hwdata->pGamepads.RIGHT_THUMB_DEADZONE );
	joystick->hwdata->pGamepads.fY2 = ConvertThumbstickValue( joystick->hwdata->pGamepads.sThumbRY, XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ); //joystick->hwdata->pGamepads.RIGHT_THUMB_DEADZONE );
